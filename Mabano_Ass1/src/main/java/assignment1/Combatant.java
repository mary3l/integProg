...
public class Combatant {
     ...
     * this other combatant simulates a combatant shooting another combatant
     */
    public void shootAtTarget(Combatant target) {
        // System.out.print(this.fighterName + " shoots " + target.getFighterName()); // for visual viewing of the simulation; commented in the final version
        ...
        if (Math.random() <= this.accuracy) { // within accuracy range
            target.killed();
            // System.out.println(" - " + target.getFighterName() + " killed."); // for visual viewing of the simulation; commented in the final version
        } else { // missed.
