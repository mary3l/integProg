...
public class MyXMLParser {
        public void parseXMLPlantCatalog(String fileName) throws Exception {
    ...
    public void parseXMLFoodMenu(String fileName) throws Exception {
    ...
    // CD CATALOG
    public void parseXMLCDCatalog(String fileName) throws Exception {
